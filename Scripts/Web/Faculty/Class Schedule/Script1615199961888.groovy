...
WebUI.setText(findTestObject('Object Repository/Faculty/Class Schedule/input_Faculty Login_username'), 'AITS051002')

WebUI.setEncryptedText(findTestObject('Object Repository/Faculty/Class Schedule/input_Faculty Login_password'), '/HuGEUzXDLUt1zEZ6TwafQ==')

WebUI.click(findTestObject('Object Repository/Faculty/Class Schedule/button_Login'))
...
WebUI.click(findTestObject('Object Repository/Faculty/Class Schedule/img'))
