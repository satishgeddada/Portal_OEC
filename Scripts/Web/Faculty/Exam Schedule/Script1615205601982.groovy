...
WebUI.setText(findTestObject('Object Repository/Faculty/Exam Schedule/input_Faculty Login_username'), 'AITS051002')

WebUI.setEncryptedText(findTestObject('Object Repository/Faculty/Exam Schedule/input_Faculty Login_password'), '/HuGEUzXDLUt1zEZ6TwafQ==')

WebUI.click(findTestObject('Object Repository/Faculty/Exam Schedule/button_Login'))
...
WebUI.click(findTestObject('Object Repository/Faculty/Exam Schedule/img'))
